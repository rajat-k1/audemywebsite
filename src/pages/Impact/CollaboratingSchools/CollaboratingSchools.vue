...
<template>
    ...
    >
        ...
        <div
            class="flex items-center justify-center mobile:justify-center w-full h-[10%] mt-[4rem] mb-[6rem] tablet:mb-[265px] mobile:mb-[129px] mobile:flex-col"
        >
            <!-- MAP Content -->
        ...
        >
            <div class="w-1/2 mobile:w-full mobile:text-center">
                <p
                    class="w-[504px] ml-[2rem] text-body text-xl font-poppins leading-8 mobile:ml-0 mobile:w-auto"
                >
