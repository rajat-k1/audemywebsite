...
<template>
    <div class="flex w-full mb-[28rem]">
        <!-- CAROUSEL COMPONENT -->
        <div class="relative w-1/2">
            <img
                src="/public/assets/images/impact/Union.png"
                class="max-w[100px]"
            />
            <img
                src="/public/assets/images/impact/Group 1135.png"
                class="absolute right-[16rem] top-[5rem] z-20"
            />
            <img
                src="/public/assets/images/impact/Group 1153.png"
        ...
        -->
            <div>
                <img
                    src="/public/assets/images/impact/carousel/tablet.svg"
                    class="absolute top-[5rem] left-[5.22rem] w-[639px] h-[462px]"
                />
                <Carousel />
            </div>
        </div>
