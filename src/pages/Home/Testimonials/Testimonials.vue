...
<template>
    ...
    >
        ...
        <div class="font-poppins flex flex-col gap-y-3">
            <h1 class="text-4.5xl text-center text-title">
        ...
        <div class="grid grid-cols-3 gap-x-20">
            ...
            >
                ...
                <div class="max-w-52 w-full flex flex-col gap-y-4 font-poppins">
                    <p class="">
                        “The blind students who played the games were very into
                        it!”
                    </p>
                    <h4 class="text-small">
            ...
            >
                ...
                <div class="max-w-52 w-full flex flex-col gap-y-4 font-poppins">
                    <p class="">
                        “Audemy’s games provide accessible and engaging
                        educational content for our blind students.”
                    </p>
                    <h4 class="text-small">
            ...
            >
                ...
                <div class="max-w-52 w-full flex flex-col gap-y-4 font-poppins">
                    <p class="">
                        “Audemy’s audio games are unique...my favorite game was
                        car counting because I love cars and math.”
                    </p>
                    <h4 class="text-small">
                        &mdash; Blind Student from Houston
                    </h4>
                </div>
            </div>
        </div>
