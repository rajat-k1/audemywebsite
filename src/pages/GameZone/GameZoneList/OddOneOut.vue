<template>
  <div class="flex flex-col justify-center items-center h-screen font-poppins bg-[#FAEDD6]">
    ...
    <div class="flex flex-col my-2 mx-56 h-96 justify-center items-center">
      <div class="m-10 py-4">
        <h1 class="text-4.5xl font-bold">Odd One Out</h1>
      </div>
...
export default {
  data() {
    return {
      ...
      isRecording: false,
      audioContext: null,
      answers: ["carrot", "refrigerator", "cup", "microwave", "spoon"],
      points: 0,
      audioNum: 0,
      transcription: '',
      resultMessage: '',
  ...
  methods: {
    ...
    playIntroAudio() {
      const introAudioPath = '/assets/oddoneout/oddoneoutintro.mp3';
    ...
    playAudio(audioNum) {
      let path = `/assets/oddoneout/odd${audioNum + 1}.mp3`;
