...
export default {
  data() {
    return {
      ...
      isRecording: false,
      audioContext: null,
      answers: ["d r i v e", "g r e a t", "m y s t e r y", "e x c i t i n g", "t a b l e"],
      points: 0,
      audioNum: 0,
      transcription: '',
      resultMessage: '',
  ...
  methods: {
    ...
    playIntroAudio() {
      const introAudioPath = '/assets/spellingBee/spellingintro.mp3';
    ...
    playAudio(audioNum) {
      let path = `/assets/spellingBee/spell${audioNum + 1}.mp3`;
